...
import { CallCenterLink } from "./call-center-link";
  ...
  return (
    <div className="flex flex-col items-center w-full h-auto mt-20">
      <div className=" flex justify-evenly w-full mt-6 mb-6 ">
        ...
        <div className="flex flex-col gap-3 text-white font-semibold cursor-pointer">
          <Link
            href="#portfolio"
            aria-label="Link para seção de Portfolio do site"
          >
      ...
      <div className="flex gap-3 mt-14 text-white">
        <Link
          href="https://www.instagram.com/danilo_kairois"
        ...
        <Link
          href="https://wa.me/message/ZAEPJ4ITGJ3WL1"
          aria-label="link para contato direto pelo WhatsApp"
        >
          <WhatsappLogo
            size={26}
            weight="fill"
        ...
        <Link
          href="https://www.linkedin.com/in/danilo-gabriel-amaral-ferreira-305457195/"
        ...
        <Link
          href="https://github.com/Danilo55Amaral"
          aria-label="link para o GitHub"
        >
          <GithubLogo size={26} weight="fill" className="hover:text-blue-700" />
        </Link>
      </div>

      <div className="text-white px-8 py-4 text-[0.625rem]">
        © 2024 Copyright{" "}
        <span className="font-semibold text-blue-700 pl-1">Danilo Amaral</span>
      </div>
    </div>
  );
}
